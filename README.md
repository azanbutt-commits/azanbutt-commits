...
I am a **Full-Stack Mobile Application Developer** passionate about building scalable and efficient mobile applications. I specialize in developing cross-platform mobile apps using **Flutter** and building robust backend services using **Node.js, PHP, and SQL databases**.

I enjoy solving real-world problems through technology and building applications that deliver smooth user experiences and reliable backend systems.
...
![ReScript](https://img.shields.io/badge/ReScript-E6484F?logo=rescript&logoColor=white)
...
![SQL Query](https://img.shields.io/badge/SQL%20Query-003B57?logo=database&logoColor=white)
